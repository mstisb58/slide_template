...
from .asset_encoder import to_data_uri, embed_css_urls, resolve_includes
...
def build_embed_html(slides_html: str) -> str:
    ...
    slides_resolved = re.sub(r'(<img\s+[^>]*src=["\'])(.*?)(["\'][^>]*>)', replace_img_src, slides_resolved, flags=re.IGNORECASE)
